...
var Chart = function (_React$Component) {
  ...
  Chart.prototype.buildDataTableFromProps = function buildDataTableFromProps() {
    ...
    if (this.props.numberFormat) {
      var numberFormatters = this.props.numberFormat instanceof Array ? this.props.numberFormat : [this.props.numberFormat];

      for (var _iterator = numberFormatters, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
        var _ref;
        ...
        var numberFormat = _ref;

        var formatter = new window.google.visualization.NumberFormat(numberFormat.options);
...
var NUMBER_FORMAT_PROP_TYPE = _react2.default.PropTypes.shape({
...
process.env.NODE_ENV !== "production" ? Chart.propTypes = {
  ...
  numberFormat: _react2.default.PropTypes.oneOfType([NUMBER_FORMAT_PROP_TYPE, _react2.default.PropTypes.arrayOf(NUMBER_FORMAT_PROP_TYPE)]),
